...
<!--
                                  ...
                                  ║                                                                                    ║
                                  ║  Are you passionate about blending technology with motorsports and performance?   ║
                                  ║  Do you love cars, engineering, and pushing the boundaries of what's possible?    ║
                                  ║                                                                                    ║
                                  ║  We're always looking for talented individuals who share our passion for:         ║
                                  ║  • High-performance automotive engineering                                         ║
                                  ║  • Cutting-edge technology in motorsports                                         ║
                                  ║  • Custom builds and automotive innovation                                         ║
                                  ║  • The intersection of code and horsepower                                         ║
                                  ║                                                                                    ║
                                  ║  🎯 MISSION: Send us an email at easteregg@essewerks.com                          ║
                                  ║                                                                                    ║
                                  ║  Tell us:                                                                          ║
                                  ║  1. Why you're passionate about working in motorsports and performance markets    ║
                                  ║  2. How you blend tech with your love of cars and engineering                     ║
                                  ║  3. How you discovered this easter egg (View Source? DevTools? Curiosity?)       ║
                                  ║                                                                                    ║
                                  ║  Whether you're a developer, engineer, designer, or just someone who gets        ║
                                  ║  excited about the perfect merge of technology and automotive excellence,         ║
                                  ║  we'd love to hear from you!                                                       ║
                                  ║                                                                                    ║
                                  ║  P.S. - This site was built with Next.js, TypeScript, and a lot of automotive    ║
                                  ║         passion. The background videos? Those are real builds in action! 🔧      ║
                                  ║                                                                                    ║
                                  ║                           Built with ❤️ and octane                               ║
                                  ║                         Overdrive Originals × Esse Werks                         ║
                                  ║                                                                                    ║
                                  ╚════════════════════════════════════════════════════════════════════════════════════╝
-->
            `}
