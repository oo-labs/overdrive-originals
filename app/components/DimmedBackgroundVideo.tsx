...
interface DimmedBackgroundVideoProps {
  crossfadeDuration: number;
}

export default function DimmedBackgroundVideo({ crossfadeDuration }: DimmedBackgroundVideoProps) {
